...
export default class RepositoryApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the uploadRepositoryById operation.
     * @callback module:api/RepositoryApi~uploadRepositoryByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/RepositoryApi~uploadRepositoryByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    uploadRepositoryById(reposName, version, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'reposName' is set
      if (reposName === undefined || reposName === null) {
        throw new Error("Missing the required parameter 'reposName' when calling uploadRepositoryById");
      }

      // verify the required parameter 'version' is set
      if (version === undefined || version === null) {
        throw new Error("Missing the required parameter 'version' when calling uploadRepositoryById");
      }
      ...
      return this.apiClient.callApi(
        '/repositories/{repos-name}/{version}/file', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the uploadRepositoryForUpdateById operation.
     * @callback module:api/RepositoryApi~uploadRepositoryForUpdateByIdCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} reposName name of Orchestra repository to store
     * @param {String} version version of Orchestra repository to store
     * @param {Object} opts Optional parameters
     * @param {File} opts.upfile The file to upload.
     * @param {module:api/RepositoryApi~uploadRepositoryForUpdateByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
    uploadRepositoryForUpdateById(reposName, version, opts, callback) {
      opts = opts || {};
      let postBody = null;

      // verify the required parameter 'reposName' is set
      if (reposName === undefined || reposName === null) {
        throw new Error("Missing the required parameter 'reposName' when calling uploadRepositoryForUpdateById");
      }

      // verify the required parameter 'version' is set
      if (version === undefined || version === null) {
        throw new Error("Missing the required parameter 'version' when calling uploadRepositoryForUpdateById");
      }
      ...
      return this.apiClient.callApi(
        '/repositories/{repos-name}/{version}/file', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
