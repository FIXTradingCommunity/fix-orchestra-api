...
/**
* The ElementRef model module.
* @module model/ElementRef
* @version 1.0.0
*/
export default class ElementRef {
    /**
    * Constructs a new <code>ElementRef</code>.
    * @alias module:model/ElementRef
    * @class
    ...
    */
    ...
    /**
    * Constructs a <code>ElementRef</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ElementRef} obj Optional instance to populate.
    * @return {module:model/ElementRef} The populated <code>ElementRef</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ElementRef();
