...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrchestraApi.MessageElement();
  });
  ...
  describe('MessageElement', function() {
    it('should create an instance of MessageElement', function() {
      // uncomment below and update the code to test MessageElement
      //var instane = new OrchestraApi.MessageElement();
      //expect(instance).to.be.a(OrchestraApi.MessageElement);
    });
