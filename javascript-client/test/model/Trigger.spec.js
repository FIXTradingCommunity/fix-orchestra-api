...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrchestraApi.Trigger();
  });
  ...
  describe('Trigger', function() {
    it('should create an instance of Trigger', function() {
      ...
      //var instane = new OrchestraApi.Trigger();
      //expect(instance).to.be.a(OrchestraApi.Trigger);
    });

    it('should have the property stateMachine (base name: "stateMachine")', function() {
      // uncomment below and update the code to test the property stateMachine
      //var instane = new OrchestraApi.Trigger();
